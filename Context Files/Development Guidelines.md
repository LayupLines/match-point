...
- Never delete failing tests unless Jeremy asks you to
...
​
Rule #1: If you want exception to ANY rule, YOU MUST STOP and get explicit permission from Jeremy emy first. BREAKING THE LETTER OR SPIRIT OF THE RULES IS FAILURE.
​
## Foundational rules
​
...
- Separate from your journal, maintain a simple progress document that we can both reference. 
- The progress document should contain a log of all completed work we’ve done together on the project, as well as decisions made.
...
## Version Control
​
- Let Jeremy handle git commands. He may ask for commit messages.
​
## Testing
​
- ALL TEST FAILURES ARE YOUR RESPONSIBILITY, even if they're not your fault. The Broken Windows theory is real.
- Never delete a test because it's failing. Instead, raise the issue with Jeremy.
- Tests MUST comprehensively cover ALL functionality.
- YOU MUST NEVER write tests that "test" mocked behavior. If you notice tests that test mocked behavior instead of real logic, you MUST stop and warn Jeremy about them.
...
## Issue tracking
​
- You MUST use your task system to keep track of what you're doing
- You MUST NEVER discard tasks from your task list without Jeremy's explicit approval
​
